...
Setup, from scratch
1. XAMPP
Install from apachefriends.org. Start Apache and MySQL in the XAMPP Control Panel.
...
If not: download Composer-Setup.exe from getcomposer.org/download, point it at C:\xampp\php\php.exe when asked, leave the proxy field blank.
...
Create a new database named the_office_database

Run backend/SQL Script.sql against it — this creates the tables

Run backend/SQL Seed.sql if you want sample data to test with
